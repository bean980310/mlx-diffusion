...
simplified_clip_lora_mapping = {
  ...
  'layers.0.linear_1.weight': ['lora_te1_text_model_encoder_layers_0_mlp_fc1.lora_up.weight',
   'lora_te1_text_model_encoder_layers_0_mlp_fc1.lora_down.weight'],
  'layers.0.linear_2.weight': ['lora_te1_text_model_encoder_layers_0_mlp_fc2.lora_up.weight',
